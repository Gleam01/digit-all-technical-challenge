'use strict';
const orientations = require('./constants/orientation');
const movements = require('./constants/movement');
const rotations = require('./constants/rotation');

function Movement(limitX, limitY) {
  ...
  function rotate(orientationLabel, rotationLabel) {
    ...
    const newOrientationIndex = (orientationIndex + rotations[rotationLabel].clockOrientationModifier + orientations.length) % orientations.length;
